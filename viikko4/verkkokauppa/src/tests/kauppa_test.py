...
class TestKauppa(unittest.TestCase):
    ...
    def test_lisataan_kaksi_eri_tuotetta_ja_metodia_tilisiirto_kutsutaan_oikeilla_tiedoilla(self):
        def varasto_saldo(tuote_id):
            if tuote_id == 1:
                return 10
            elif tuote_id == 2:
    ...
    def test_lisataan_kaksi_samaa_tuotetta_ja_metodia_tilisiirto_kutsutaan_oikeilla_tiedoilla(self):
        def varasto_saldo(tuote_id):
            if tuote_id == 1:
                return 10
    ...
    def test_lisataan_tuote_jota_on_ja_tuote_jota_ei_ole_varastossa(self):
        def varasto_saldo(tuote_id):
            if tuote_id == 1:
                return 10
            elif tuote_id == 2:
    ...
    def test_pyydetaan_uusi_viitenumero_jokaiseen(self):
        def varasto_saldo(tuote_id):
            if tuote_id == 1:
                return 10
            elif tuote_id == 2:
